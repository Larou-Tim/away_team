...
'monster', 3, 1, '"I''m here to carry out Lord Vader''s orders as inadequately as possible"', FALSE, FALSE);
...
'monster', 12, 1, '"I will destroy your reality! ...you should thank me."', FALSE, FALSE);
INSERT INTO Doors (name, type, level, treasure, description, createdAt, updatedAt) VALUES ('Rassilon', 
'monster', 10, 1, '"The final act of your life is murder. But which one of us?"', FALSE, FALSE);
...
'monster', 2, 2, '"You''re about to see that evil always triumphs because good is dumb."', FALSE, FALSE);
...
'curse', '-9', 'player_level', 'You get turned into a Red Shirt and are promptly killed. Patrick Stewart and his exclusive clique of friends are OK so it''s cool', FALSE, FALSE);
...
'weapon', '3', 'Small but powerful. Basically the opposite of your mom.', FALSE, FALSE);
...
INSERT INTO Treasures
    (name, type, effect, description, createdAt, updatedAt)
VALUES
    ('Freeze Ray',
...
INSERT INTO Treasures
    (name, type, effect, description, createdAt, updatedAt)
VALUES
    ('Ruby Rhod''s cheetah print body suit',
...
'helper', '3', 'You hire Rocket and Groot to assist you on the condition you don''t pet Rocket.', FALSE, FALSE);
...
'helper', '2', 'You found a multipass! While it will help you get around faster, the real value is getting to contiunuously repeat MULTIPASS', FALSE, FALSE);
...
'helper', '3', 'Always good to have someone on your team that shoots first...', FALSE, FALSE);
INSERT INTO Treasures
    (name, type, effect, description, createdAt, updatedAt)
VALUES
    ('Towel',
        'helper', '2', 'Because you should never leave home without your towel', FALSE, FALSE);




INSERT INTO Treasures (name, type, effect, description, createdAt, updatedAt) VALUES ('Enterprise', 
'ship', '4', 'And with you, so ends the streak of the SS Enterprise having a charismatic, good-looking captain.', FALSE, FALSE);
...
'ship', '3', '"You came in that thing?"', FALSE, FALSE);
INSERT INTO Treasures (name, type, effect, description, createdAt, updatedAt) VALUES ('TARDIS', 
'ship', '3', 'Able to fly through space and time. The drawback to this ship are the police stickers, causing other ships in front of you to fly 5 below the speed limit.', FALSE, FALSE);
INSERT INTO Treasures
    (name, type, effect, description, createdAt, updatedAt)
VALUES
    ('Heart of Gold',
        'ship', '2', 'Stolen from the original theif, Zaphod Beeblebrox, it''s one of the fastest ships in the universe due to the Infinite Improbability Drive, be careful though,, because you may end up as a sofa.', FALSE, FALSE);
